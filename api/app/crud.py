...
def create_contribution(*, session: Session, contribution_in: ContributionCreate, owner_id: uuid.UUID) -> Contribution:
    db_contribution = Contribution.model_validate(contribution_in, update={"owner_id": owner_id})
...
def get_contribution_by_id(*, session: Session, contribution_id: uuid.UUID) -> Contribution | None:
