    ...
    fetch(blobUrl)
      ...
      .then(async (blob) => {
        ...
        const response = await axios
          .post("http://localhost:8002/v1/audio/transcriptions", formData, {
          ...
          console.info(`KAIROS - JUST BEFORE DECLARING STREALING EVENT HANDLERS`)
          stream.on('data', (chunk) => {
            // logic to process stream data
            // const transcribedMessage = chunk.data;
            // const transcribedMessage = chunk.toString();
            const transcribedMessage = chunk;
            console.log(`Speaches AI returned: [${JSON.stringify({jbl_transcribedMessage: transcribedMessage}, null, 2)}]`)
